...
class GameSettings:
    """Класс с базовыми настройками ширины и высоты игрового поля, цветами, текстом и FPS; содержит статические методы
    для выхода через ESC и для запуска игрового цикла, ожидающего нажатия клавиши пользователем
